...
<!--flat theme plugins-->
<script id="serialexpand-script" type="text/javascript" src="<c:url value="/themes/flat-sysper/jquery.serialexpand.js"/>"></script>
<script id="serialtabs-script" type="text/javascript" src="<c:url value="/themes/flat-sysper/jquery.serialtabs.js"/>"></script>
<script id="serialaccordion-script" type="text/javascript" src="<c:url value="/themes/flat-sysper/jquery.serialaccordion.js"/>"></script>
<script id="serialbox-script" type="text/javascript" src="<c:url value="/themes/flat-sysper/jquery.serialbox.js"/>"></script>
