...
<head>
    ...
    <%-- DEFAULT USAGE --%>
    <link rel="stylesheet" href="<c:url value="/styles/@main.bootstrap.only.css@"/>" type="text/css" media="screen"/>
    ...
    <link rel="stylesheet" href="<c:url value="/styles/@main.print.bootstrap.only.css@"/>" type="text/css" media="print"/>
