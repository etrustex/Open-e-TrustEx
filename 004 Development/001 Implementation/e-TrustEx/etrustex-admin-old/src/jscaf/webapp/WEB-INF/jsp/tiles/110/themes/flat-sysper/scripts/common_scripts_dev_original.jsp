...
<!--flat theme plugins-->
<script id="serialexpand-script" type="text/javascript" src="<c:url value="/themes/flat-sysper/jquery.serialexpand.js?v=@build.timestamp@"/>"></script>
<script id="serialtabs-script" type="text/javascript" src="<c:url value="/themes/flat-sysper/jquery.serialtabs.js?v=@build.timestamp@"/>"></script>
<script id="serialaccordion-script" type="text/javascript" src="<c:url value="/themes/flat-sysper/jquery.serialaccordion.js?v=@build.timestamp@"/>"></script>
<script id="serialbox-script" type="text/javascript" src="<c:url value="/themes/flat-sysper/jquery.serialbox.js?v=@build.timestamp@"/>"></script>
