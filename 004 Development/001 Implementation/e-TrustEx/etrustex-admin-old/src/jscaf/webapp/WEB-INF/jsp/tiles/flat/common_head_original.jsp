...
<head>
    ...
    <%-- DEFAULT USAGE --%>
    <link rel="stylesheet" href="<c:url value="/styles/@main.flat.css@"/>" type="text/css" media="screen"/>
    ...
    <link rel="stylesheet" href="<c:url value="/styles/@main.print.css@"/>" type="text/css" media="print"/>
    ...
    <%-- DEFAULT USAGE --%>
    <script src="<c:url value="/scripts/@main.flat.full.js@"/>"></script>
