...
<head>
    ...
    <link rel="SHORTCUT ICON" href="<c:url value="/images/app.ico"/>"/>

    <%-- jSCAF MAIN PRINT CSS --%>
    <link rel="stylesheet" href="<c:url value="/styles/@main.print.css@"/>" type="text/css" media="screen,print"/>
    ...
    <script src="<c:url value="/scripts/@main.full.js@"/>"></script>
    ...
    <script src="<c:url value="/scripts/jscaf/modules/@mod.common-helpers.js@"/>"></script>
