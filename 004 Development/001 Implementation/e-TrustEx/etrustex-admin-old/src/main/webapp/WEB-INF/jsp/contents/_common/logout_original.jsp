...
<head>
    ...
    <title>xxxCIPAdmin LOGOUT</title>
    <link rel="SHORTCUT ICON" href="<c:url value="/styles/images/mips.ico"/>"/>
...
<div id="main">
    ...
    <div id="main-content">
        ...
        <div class="inner-box" style="margin-left:40%; margin-bottom: 5px; width:250px">
            ...
            <div class="text-color-blue center">
                <h3>LOGOUT main message</h3>
            </div>
            <br>
