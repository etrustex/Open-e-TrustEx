...
<%@ tag description="Generate box extended ..." %>

<%@ attribute name="excel_export" required="false" type="java.lang.String" description="" %>
        ...
        <div class="header">
            ...
            <h2 class="${box_title_class}">
                ...
                <% } else { %>
                    ${box_title_text}
                <% } %>
                <% if (null!=excel_export && excel_export.equals("true")) {  %>
					<j:button action_id="action_export" 
							  action_class="fr" 
							  button_icon_class="icon-xls-report"  />
				<% } %>
            </h2>
            <div class="cl"></div>          
        </div>		
