...
public class InterchangeAgreementValidator implements Validator {
    ...
    public boolean supports(Class<?> clazz) {
        return InterchangeAgreementForm.class.equals(clazz);
    }
    ...
    public void validate(Object target, Errors errors) {
        ...
        if (icaId != null) { // update
            ...
            icaUtil.validateStartDate(ica.getIcaValidityStartDate(), interchangeAgreement.getValidityStartDate(), errors);
        } else {
            icaUtil.validateStartDate(ica.getIcaValidityStartDate(), null, errors);
            icaUtil.validateProfile(ica.getProfile(), userInfo, errors);
