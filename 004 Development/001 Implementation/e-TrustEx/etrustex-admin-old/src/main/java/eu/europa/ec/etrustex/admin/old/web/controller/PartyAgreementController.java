...
import eu.europa.ec.etrustex.admin.old.web.validators.PartyAgreementSearchValidator;
import eu.europa.ec.etrustex.admin.old.web.validators.PartyAgreementValidator;
...
public class PartyAgreementController {
    ...
    @Autowired
    private PartyAgreementValidator partyAgreementValidator;
    @Autowired
    private PartyAgreementSearchValidator partyAgreementSearchValidator;
    @Autowired
