...
public enum ErrorResponseCode {
	...
	AUTHENTICATION_FAILED(null, "Unauthorized Access", "ERR_MSG", "Client"),
	...
	public static ErrorResponseCode getByCode(String code) {
		...
		throw new RuntimeException("Unable to find the error code " + code + ". Please update the class [eu.cec.ellipcis.domain.ErrorResponseCode] containing the error codes.");
	}
