...
@Component("CreateInterchangeAgreement-2.0")
public class CreateInterchangeAgreementService_2 extends TrustExBusinessService implements ISynchBusinessService {
	...
	public TrustExMessage<String> processMessage(TrustExMessage<String> message) throws BusinessException, TechnicalErrorException {
		try {
			...
			Party senderParty = partyService.getPartyByID(IdentifierIssuingAgency.valueOf(senderPartySchemeId.replaceAll(":", "_")), 
					senderPartyId, message.getHeader().getIssuer().getBusinessDomain());
			if (senderParty != null) {
			...
			Party receiverParty = partyService.getPartyByID(IdentifierIssuingAgency.valueOf(receiverPartySchemeId.replaceAll(":", "_")), 
					receiverPartyId, message.getHeader().getIssuer().getBusinessDomain());
