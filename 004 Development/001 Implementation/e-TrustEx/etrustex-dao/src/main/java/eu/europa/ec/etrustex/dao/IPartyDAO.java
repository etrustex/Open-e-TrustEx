...
public interface IPartyDAO extends ITrustExDAO<Party, Long> {
    ...
    List<Party> findPartiesByCriteria(String name, String username, String identifierValue, List<Long> businessDomainIds, Boolean isThirdParty, Boolean hasNoPartyRole);
