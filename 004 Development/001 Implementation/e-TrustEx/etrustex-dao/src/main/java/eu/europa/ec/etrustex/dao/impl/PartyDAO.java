...
//		return getUniqueByAttribute(Party_.name, name);
	...
	@Override
	public List<Party> findPartiesByCriteria(String name, String username, String identifierValue, List<Long> businessDomainIds, Boolean isThirdParty, Boolean hasNoPartyRole) {
		...
		if((hasNoPartyRole != null) && hasNoPartyRole){
			predicates.add(cb.isEmpty(party.get(Party_.partyRoles)));
		}
