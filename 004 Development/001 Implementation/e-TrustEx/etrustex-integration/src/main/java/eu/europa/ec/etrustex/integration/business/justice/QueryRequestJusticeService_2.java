		...
		try {
			...
			if (requestParameter != null){
				...
				RetrieveMessagesForQueryRequestDTO queryDTO = new RetrieveMessagesForQueryRequestDTO.Builder()
						...
						.setUserId(userId)
						.setBusinessDocumentTypes(businessDocumentTypes)
						.setPaginationFrom(paginationFrom)
						.setPaginationTo(paginationTo)
						.setSortField(sortField)
						.setFilterOutMessagesInError(filterOutMessagesInError)
						.build();
				queryResults = messageService.retrieveMessagesWithConversation(queryDTO);
					...
					queryResults.getMessages().addAll(messageService.retrieveMessagesForQueryRequest(builder.build()));
			...
			for (Message msg : queryResults.getMessages()) {
				...
				for (Message parentMessage : msg.getParentMessages()) {
					docParentRef.getParentDocument().add(populateParentDocInfo(parentMessage));					
				}
