...
import ec.schema.xsd.inboxresponse_3.InboxResponseType;
import ec.schema.xsd.inboxresponse_3.ObjectFactory;
...
public class InboxService_3 extends TrustExBusinessService implements ISynchBusinessService{
	
	private static final Logger logger = LoggerFactory.getLogger(InboxService_3.class);
