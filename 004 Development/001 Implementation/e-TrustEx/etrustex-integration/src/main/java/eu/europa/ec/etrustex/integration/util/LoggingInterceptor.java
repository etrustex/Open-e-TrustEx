...
public class LoggingInterceptor {
	...
	@AfterThrowing(pointcut="execution(public * eu.europa.ec.etrustex.integration.service.*.*(..)) "
			+ "&& !execution(public * eu.europa.ec.etrustex.integration.service.MessageBinaryServiceActivator..*(..))", throwing="ex")
...
//	@Around(value="execution(public * eu.europa.ec.etrustex.integration.service.*.*(..)) ") 
...
//	@Around(value="execution(public * eu.europa.ec.etrustex.services.dao.*.*(..)) ") 
