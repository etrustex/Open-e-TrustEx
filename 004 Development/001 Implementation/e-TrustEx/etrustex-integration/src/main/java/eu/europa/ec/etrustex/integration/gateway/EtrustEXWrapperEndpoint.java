...
public class EtrustEXWrapperEndpoint implements MessageEndpoint {
	...
	public void invoke(MessageContext messageContext) {
		...
		try {
			...
			soapService.validateSOAPMessage(request.getEnvelope().getSource(), wsRootQname.toString());
			...
			logDTO.setBusinessDomain(soapService.retrieveBusinessDomain());
