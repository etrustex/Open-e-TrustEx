...
public class CannonicalServiceActivator  {
	...
	private static final Logger logger = LoggerFactory.getLogger(CannonicalServiceActivator.class);
	...
	public String createCanonical(TrustExMessage<String> message,
								  eu.europa.ec.etrustex.domain.Message internalMessage,
								  eu.europa.ec.etrustex.domain.Message internalParentMessage)
		...
		try {
			...
			eu.europa.ec.etrustex.domain.Document doc = internalMessage.getTransaction().getDocument();
			...
			namespace = namespace.replaceAll("-2.2", "-0.1");
			...
			if (internalParentMessage != null) {
				eu.europa.ec.etrustex.domain.Message parentMessage = internalParentMessage;
			...
			logger.error("Error creating the canonical",e);
