...
public class WrapperEnpointUtil_2_0 extends AbstractWrapperEndpointUtil{
	...
	private static final Logger logger = LoggerFactory.getLogger(WrapperEnpointUtil_2_0.class);
	...
	public HeaderType extractHeader(MessageContext messageContext,
		...
		if (headerNode.getAttributes().getNamedItem("xmlns") != null){
			headerNode.getAttributes().removeNamedItem("xmlns");
		}
		headerNode = headerNode.getOwnerDocument().renameNode(headerNode, "ec:schema:xsd:CommonAggregateComponents-2", "HeaderType");
		JAXBElement headerObject = (JAXBElement) unmarshaller.unmarshal(headerNode, HeaderType.class);
