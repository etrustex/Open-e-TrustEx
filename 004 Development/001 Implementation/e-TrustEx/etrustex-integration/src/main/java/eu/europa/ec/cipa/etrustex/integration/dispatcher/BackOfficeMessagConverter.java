...
import eu.europa.ec.cipa.etrustex.integration.service.CannonicalServiceActivator;
...
public class BackOfficeMessagConverter implements ITrustExJmsMessageConverter {
	...
	public Message toMessage(TrustExMessage<String> message, Session session)
		...
		try{
			...
			eu.europa.ec.cipa.etrustex.domain.Message dbMsg = messageService.retrieveMessage(message.getHeader().getMessageId());
			//
