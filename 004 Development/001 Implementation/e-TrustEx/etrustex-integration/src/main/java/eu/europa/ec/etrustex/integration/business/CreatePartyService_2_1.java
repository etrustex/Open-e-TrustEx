...
public class CreatePartyService_2_1 extends TrustExBusinessService implements ISynchBusinessService {
	...
	private void retrieveCertificate(Party party, TrustExMessage<String> message, CreatePartyType partyRequest) throws XPathException, IOException, CertificateException, NoSuchAlgorithmException, WSSecurityException{
	...
	private void retrieveCredentials(DocumentInfo documentInfo, Configuration configuration, Party party, TrustExMessage<String> message) throws XPathException, NoSuchAlgorithmException {
		...
		final SequenceIterator<NodeInfo> credIter = queryForNode(XPATH_CREDENTIALS, documentInfo, configuration);
		NodeInfo credentialsNode = credIter.next();
