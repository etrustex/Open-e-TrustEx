...
public class SubmitDocumentBundle_3 extends TrustExBusinessService implements
		IASynchBusinessService {
	
	private static final Logger logger = LoggerFactory.getLogger(SubmitDocumentBundle_3.class);
