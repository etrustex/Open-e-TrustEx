...
import eu.europa.ec.etrustex.integration.util.JmsHeaders;
import eu.europa.ec.etrustex.integration.util.MessageHeaders;
...
public class TrustExMessageHeader implements Serializable{
	...
	private String messageParentDocumentIssuer;
	...
	private String humanReadableTemplateName;
	...
	public String getMessageParentDocumentIssuer() {
		return messageParentDocumentIssuer;
	}

	public void setMessageParentDocumentIssuer(String messageParentDocumentIssuer) {
		this.messageParentDocumentIssuer = messageParentDocumentIssuer;
	}

	public String getHumanReadableTemplateName() {
		return humanReadableTemplateName;
	}

	public void setHumanReadableTemplateName(String humanReadableTemplateName) {
		this.humanReadableTemplateName = humanReadableTemplateName;
	}
