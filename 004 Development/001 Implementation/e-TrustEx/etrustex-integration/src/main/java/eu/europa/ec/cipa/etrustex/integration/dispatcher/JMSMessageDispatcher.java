...
public class JMSMessageDispatcher extends MessageDispatcher implements ApplicationContextAware {
	...
	protected void sendMessage(TrustExMessage<String> message) throws MessageRoutingException {
		...
		if (endpoint.getIsAuthenticationRequired()){
		...
		try {
			...
			if(!endpoint.getIsSupportingReplyTo()){
				...
				Map<MetaDataItemType, MetaDataItem> metadata=  metadataService.retrieveMetaData(null, null, null, (Long)null);
	...
	private String translateStatusCodeValue(String statusCode, eu.europa.ec.cipa.etrustex.domain.Message message, eu.europa.ec.cipa.etrustex.domain.Message parentMessage) {
		...
		//
		//ode: don't translate anymore received to sent !!
