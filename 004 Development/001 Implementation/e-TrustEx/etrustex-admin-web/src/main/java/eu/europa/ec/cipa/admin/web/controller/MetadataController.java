...
import eu.europa.ec.cipa.admin.web.validators.MetadataSearchValidator;
import eu.europa.ec.cipa.admin.web.validators.MetadataValidator;
...
public class MetadataController {
	...
	@Autowired private MetadataValidator metadataValidator;
	@Autowired private MetadataSearchValidator metadataSearchValidator;
	...
	public void initBinder(WebDataBinder binder) {
		...
		binder.registerCustomEditor(Set.class, "profiles", new CustomCollectionEditor(Set.class) {
			...
			protected Object convertElement(Object element) {
				...
				return profileId.equals(new Long(-1)) ? null : profileService.getProfile(profileId);
			}
		});
	}
	...
	public String viewLoad(@PathVariable("metadataItemId") Long metadataItemId, @ModelAttribute("metadataSearchForm") MetadataSearchForm metadataSearchForm,
		...
		try{
			...
			populateForm(model, new MetadataForm(), "view", userInfo);
		}
...
//		populateSearchForm(model, metadataForm, "edit");
	...
	private MetaDataItem toDomain(MetadataForm metadataForm) {
		...
		Profile profile = metadataForm.getProfile() != null && metadataForm.getProfile().getId() != null && !metadataForm.getProfile().getId().equals(new Long(-1))
	...
	private MetaDataItem toDomain(MetadataSearchForm metadataSearchForm) {
		...
		Profile profile = metadataSearchForm.getProfile_search() != null && metadataSearchForm.getProfile_search().getId() != null && !metadataSearchForm.getProfile_search().getId().equals(new Long(-1))
