...
import eu.europa.ec.cipa.admin.web.dto.CredentialsDTO;
import eu.europa.ec.cipa.admin.web.dto.PartyIdentifierDTO;
import eu.europa.ec.cipa.admin.web.dto.PartyView;
...
import eu.europa.ec.cipa.etrustex.services.ICredentialsService;
import eu.europa.ec.cipa.etrustex.services.IPartyAgreementService;
import eu.europa.ec.cipa.etrustex.services.IPartyIdentifierService;
 ...
 */
@Component 
//TODO: batrian: this class is partially used
...
//	@Autowired private CertificateValidator certificateValidator;
	...
	public void validate(Object target, Errors errors) {
		...
		boolean isNewParty = partyView.getId() == null ? true : false;
...
//	}
	 ...
	 * @return 
	 * 		true, if the list is empty or all identifiers in the list are marked for deletion
	 ...
	 * @param pi
	 * @return
	 * 		true, if there is an identifier with the same type in the list and not marked for deletion
