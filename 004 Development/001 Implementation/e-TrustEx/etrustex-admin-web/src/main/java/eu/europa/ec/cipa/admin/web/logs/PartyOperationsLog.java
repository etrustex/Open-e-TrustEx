...
/*	private Logger log = LoggerFactory.getLogger(this.getClass());
	...
	@Pointcut("execution(* eu.europa.ec.cipa.admin.web.controller.PartyController.save(.., javax.servlet.http.HttpServletRequest)) && args(.., request)")
    public void saveOperation(HttpServletRequest request) {}
	
	@Pointcut("execution(* eu.europa.ec.cipa.admin.web.controller.PartyController.delete(.., javax.servlet.http.HttpServletRequest)) && args(.., request)")
    public void deleteOperation(HttpServletRequest request) {}
	
	@Pointcut("execution(* eu.europa.ec.cipa.admin.web.controller.PartyController.searchResults(.., org.springframework.validation.BindingResult)) "
			+ "&& args(.., result)")
	public void searchOperation1(BindingResult result) {}
	
	@Pointcut("execution(* eu.europa.ec.cipa.admin.web.controller.PartyController.searchResults(.., javax.servlet.http.HttpServletRequest)) "
			+ "&& args(.., request)")
	public void searchOperation2(HttpServletRequest request) {}
	
	@Pointcut("execution(* eu.europa.ec.cipa.admin.web.controller.PartyController.view(.., javax.servlet.http.HttpServletRequest)) && args(.., request)")
