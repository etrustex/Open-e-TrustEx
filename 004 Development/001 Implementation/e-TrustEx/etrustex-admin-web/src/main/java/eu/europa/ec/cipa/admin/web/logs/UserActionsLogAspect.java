...
//    @Pointcut(value = "@annotation(org.springframework.web.bind.annotation.RequestMapping) && !@annotation(eu.europa.ec.cipa.admin.web.logs.UserActionsLog)")
//    public void otherHandlerMethods() {}

	@Pointcut("execution(* eu.europa.ec.cipa.admin.web.controller.*.save(..)) && args(form, ..)")
    public void saveOperation(Object form) {}
	
	@Pointcut("execution(* eu.europa.ec.cipa.admin.web.controller.*.delete(..)) && args(id, ..)")
    public void deleteOperation(Long id) {}
	
	@Pointcut("execution(* eu.europa.ec.cipa.admin.web.controller.*.searchResults(..)) && args(*, result, ..)")
	public void searchOperation(BindingResult result) {}
	
	@Pointcut("execution(* eu.europa.ec.cipa.admin.web.controller.*.view(..)) && args(id, ..)")
