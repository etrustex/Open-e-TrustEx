...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/styles/font_min.css?v=@build.timestamp@"/>" type="text/css" media="screen"/>
    <link rel="stylesheet" href="<c:url value="/styles/font_max.css?v=@build.timestamp@"/>" type="text/css" media="screen"/>
    ...
    <link rel="stylesheet" href="<c:url value="/themes/flat-sysper/flat.css?v=@build.timestamp@"/>" type="text/css" media="screen"/>
    ...
    <script src="<c:url value="/scripts/jscaf/modules/display.js?v=@build.timestamp@"/>"></script>
    ...
    <%--SPA USAGE
    <script src="<c:url value="/scripts/jscaf/modules/spa.js"/>"></script>
    <script src="<c:url value="/scripts/jscaf/modules/spa-init.js"/>"></script>
    --%>
