...
public interface IEndpointService {
	...
	boolean existsEndpointForUsernameAndUrl(Credentials credentials, Long businessDomainId, Class<? extends Endpoint> endpointClass, String url, Long endpointId, Long newCredentialId);
}
