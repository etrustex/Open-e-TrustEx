...
public class LogDTO {
	...
	public enum LOG_OPERATION {
        ...
        CREATE, UPDATE, DELETE, VIEW, SEARCH, REDISPATCH, RESUBMIT;
        ...
        public static List<LOG_OPERATION> cipadminOperations() {
            List<LOG_OPERATION> ops = Arrays.asList(AUTHENTICATION, AUTHORIZATION, CREATE, UPDATE, DELETE, VIEW, SEARCH, REDISPATCH, RESUBMIT);
	...
	public static class LogDTOBuilder {
		...
		public LogDTOBuilder module(String module) {
			this.module = module;
			return this;
		}
