...
public interface IPartyService {
	...
	/**
	 * Returns a list with the roles of the given party.
	 * @param party
	 * 		the party for which the roles are needed
	 * @return
	 * 		the roles for the given party
	 */
	public List<Role> getRolesFor(Party party);
//	/**
//	 * Returns a list with all parties that
//	 * @return
//	 */
//	public List<Party> getAllSuppliers();
	...
	public List<Party> getPartiesForBusinessDomain(
			String name, String username, String identifierValue, List<Long> businessDomainIds);
...
//    List<PartyListItemDTO> getPartiesForUser(Long businessDomainId, UserRole role, List<PartyListItemDTO> userParties);
}
