...
import eu.europa.ec.cipa.etrustex.services.dao.admin.IUserDAO;
...
public class UserService implements IUserService {
	...
	public UserRole getUserRole(String username, Long domainId) {
		...
		if (userAccessRights != null && userAccessRights.size() > 0) {
			for (UserAccessRights accesRight : userAccessRights) {
				if (accesRight.getBusinessDomain() != null 
					...
					logger.info("UserService - getUserRole(username {}, domainId {}): {}", username, domainId, accesRight.getRole());
		...
		logger.info("UserService - getUserRole(username {}, domainId {}): {}", username, domainId, null);
		return null;
	}
	...
	public List<PartyListItemDTO> getUserParties(String username, Long domainId) {
		...
		logger.info("UserService - getUserParties(username {}, domainId {}): found {} parties", username, domainId, userParties.size());
	...
	public List<User> getUsers(Long userRoleId,
		...
		return userDAO.getUsers(userRoleId, businessDomainId, partyId);
	}
