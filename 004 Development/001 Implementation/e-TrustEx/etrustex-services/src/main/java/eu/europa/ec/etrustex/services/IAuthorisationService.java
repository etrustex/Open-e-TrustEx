...
public interface IAuthorisationService {
	 ...
	 * @param profile the profile indicated in the message-payload
	 ...
	 */
	public InterchangeAgreement checkAuthorisation(Party issuerParty, Party senderParty, Party receiverParty,Long transactionId,  Profile profile) throws AuthorisationFailedException;
