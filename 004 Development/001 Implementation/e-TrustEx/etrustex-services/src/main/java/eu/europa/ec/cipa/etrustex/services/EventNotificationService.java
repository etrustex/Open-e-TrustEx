...
public class EventNotificationService implements IEventNotificationService {
    ...
    @Override
    public List<Party> getPartiesConfiguredToReceiveEventNotification(eu.europa.ec.cipa.etrustex.types.EventNotificationType eventType, Long businessDomainId, Long profileId) {
