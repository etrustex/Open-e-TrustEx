	...
	public void onStartup(ServletContext servletContext) throws ServletException {
	 ...
	 // dispatcher wrapperServletContext
	    ...
	    Map<String, String> wrapperParams = new HashMap<>();
 		...
 		// postRedirectJUST Servlet
 		ServletRegistration.Dynamic postRedirectJUST = servletContext.addServlet("PostRedirectJUST", new PostRedirect());
 		//KEY metadata to retrieve target URL
 		postRedirectJUST.setInitParameter("REDIRECT_KEY", "JUST_TEST_ENDPOINT");
 		postRedirectJUST.setInitParameter("wl-dispatch-policy", "postRedirectWorkManager");		
		postRedirectJUST.addMapping("/RedirectApplicationResponse-2.0");
		postRedirectJUST.addMapping("/RedirectDocumentBundle-2.0");
		postRedirectJUST.addMapping("/RedirectDocumentWrapper-2.0");
		postRedirectJUST.addMapping("/RedirectQueryRequest-2.0");
		postRedirectJUST.addMapping("/RedirectRetrieveRequest-2.0");
		postRedirectJUST.addMapping("/RedirectStatusRequest-2.0");
