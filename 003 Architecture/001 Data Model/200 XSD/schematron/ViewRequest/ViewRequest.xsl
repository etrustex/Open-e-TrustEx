...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                xmlns:ec="ec:schema:xsd:ViewRequest-1"
...
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Business rules for e-TrustEx ViewRequest"
                              schemaVersion="">
         ...
         <svrl:ns-prefix-in-attribute-values uri="urn:oasis:names:specification:ubl:schema:xsd:DocumentStatusCode-1.0"
                                             prefix="stat"/>
         <svrl:ns-prefix-in-attribute-values uri="ec:schema:xsd:ViewRequest-1" prefix="ec"/>
         ...
         <svrl:active-pattern>
            <xsl:attribute name="id">ViewRequest_code_list_rules</xsl:attribute>
            <xsl:attribute name="name">ViewRequest_code_list_rules</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
   ...
   <!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Business rules for e-TrustEx ViewRequest</svrl:text>

   <!--PATTERN -->


	<!--RULE -->
<xsl:template match="*[local-name()='ViewRequest']" priority="1000" mode="M10">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[local-name()='ViewRequest']"/>
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="*[local-name()='ViewRequest']" priority="1000" mode="M11">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[local-name()='ViewRequest']"/>
...
<xsl:choose>
   ...
   <!--PATTERN ViewRequest_code_list_rules-->
