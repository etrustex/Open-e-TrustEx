...
<ns prefix="qdt" uri="urn:oasis:names:specification:ubl:schema:xsd:QualifiedDatatypes-2"/>
  ...
  <ns prefix="ec" uri="ec:schema:xsd:ViewRequest-1"/>
...
<pattern name="receiver party id check">
  <rule context="*[local-name()='ViewRequest']">
    ...
    <pattern id="ViewRequest_code_list_rules">
<!--
...
<!--
    ...
    ViewRequest code list rules for the e-TrustEx project at the European Commission (DIGIT) by PwC
