...
<pattern name="documenttypecode check">
  <rule context="*[local-name()='DocumentReferenceRequest']/cbc:DocumentTypeCode">
    ...
    <pattern id="DeleteDocumentWrapper_code_list_rules">
<!--
...
<!--
    ...
    DeleteDocumentWrapper code list rules for the e-TrustEx project at the European Commission (DIGIT) by PwC
