...
<title>Business rules for e-TrustEx RetrieveRequest</title>
<ns prefix="qdt" uri="urn:oasis:names:specification:ubl:schema:xsd:QualifiedDatatypes-2"/>
  ...
  <ns prefix="ec" uri="ec:schema:xsd:RetrieveRequest-1"/>
  <ns prefix="fn" uri="http://www.w3.org/2005/xpath-functions"/>
  <ns prefix="xs" uri="http://www.w3.org/2001/XMLSchema"/>
<pattern name="sender party id check">
  <rule context="*[local-name()='RetrieveRequest']">
...
<pattern name="receiver party id check">
  <rule context="*[local-name()='RetrieveRequest']">
    ...
    <pattern id="RetrieveRequest_code_list_rules">
<!--
...
<!--
    ...
    RetrieveRequest code list rules for the e-TrustEx project at the European Commission (DIGIT) by PwC
