...
<ns prefix="qdt" uri="urn:oasis:names:specification:ubl:schema:xsd:QualifiedDatatypes-2"/>
  ...
  <ns prefix="ec" uri="ec:schema:xsd:DocumentBundleJustice-1"/>
...
<pattern name="countrySubentityCode check">
  <rule context="cac:ReceiverParty">
    ...
    <pattern id="DocumentBundleJustice_code_list_rules">
<!--
...
<!--
    ...
    DocumentBundleJustice code list rules for the e-TrustEx project at the European Commission (DIGIT)
