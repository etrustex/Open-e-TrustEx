...
<title>Business rules for e-TrustEx RetrieveDocumentWrapperRequest</title>
<ns prefix="qdt" uri="urn:oasis:names:specification:ubl:schema:xsd:QualifiedDatatypes-2"/>
  ...
  <ns prefix="ec" uri="ec:schema:xsd:DocumentWrapperRequest-0.1"/>
  <ns prefix="fn" uri="http://www.w3.org/2005/xpath-functions"/>
  <ns prefix="xs" uri="http://www.w3.org/2001/XMLSchema"/>
<pattern name="sender party id check">
  <rule context="*[local-name()='DocumentWrapperRequest']">
    <assert flag="error" test="not ( normalize-space(cac:SenderParty/cbc:EndpointID) = '' )">error.senderpartyid_check</assert>
  </rule>
</pattern>
    <pattern id="RetrieveDocumentWrapperRequest_code_list_rules">
<!--
...
<!--
    ...
    RetrieveDocumentWrapperRequest code list rules for the e-TrustEx project at the European Commission (DIGIT) by PwC
